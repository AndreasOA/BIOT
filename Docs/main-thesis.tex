...
\usepackage{csquotes}
\usepackage[backend=biber,citestyle=numeric,sortcites=true,maxcitenames=2,style=ACM-Reference-Format,sorting=none]{biblatex}
...
\title{Evaluating xLSTM for EEG Seizure Classification}
...
\author{Andreas Oberdammer \suffix{BSc}\matno{11908776}}
...
\supervisor{\prefix{Univ. Prof. Mag. Dr.} Günther~Klambauer}

%% Command \assistantsupervisor{name}: sets the name of the assistant supervisor(s)
\assistantsupervisor{\prefix{Dr.} Philipp~Seidl \suffix{MSc}}
